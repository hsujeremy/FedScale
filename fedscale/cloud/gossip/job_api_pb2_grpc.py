...
from . import job_api_pb2 as job__api__pb2
...
class JobServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.REQUEST_WEIGHTS = channel.unary_unary(
                '/fedscale.JobService/REQUEST_WEIGHTS',
                request_serializer=job__api__pb2.WeightRequest.SerializeToString,
                response_deserializer=job__api__pb2.ServerResponse.FromString,
                )
        self.UPLOAD_WEIGHTS = channel.unary_unary(
                '/fedscale.JobService/UPLOAD_WEIGHTS',
                request_serializer=job__api__pb2.UploadWeightRequest.SerializeToString,
                response_deserializer=job__api__pb2.ServerResponse.FromString,
                )
...
def add_JobServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'REQUEST_WEIGHTS': grpc.unary_unary_rpc_method_handler(
                    servicer.REQUEST_WEIGHTS,
                    request_deserializer=job__api__pb2.WeightRequest.FromString,
                    response_serializer=job__api__pb2.ServerResponse.SerializeToString,
            ),
            'UPLOAD_WEIGHTS': grpc.unary_unary_rpc_method_handler(
                    servicer.UPLOAD_WEIGHTS,
                    request_deserializer=job__api__pb2.UploadWeightRequest.FromString,
                    response_serializer=job__api__pb2.ServerResponse.SerializeToString,
            ),
    }
...
class JobService(object):
    ...
    def REQUEST_WEIGHTS(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fedscale.JobService/REQUEST_WEIGHTS',
            job__api__pb2.WeightRequest.SerializeToString,
            job__api__pb2.ServerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UPLOAD_WEIGHTS(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fedscale.JobService/UPLOAD_WEIGHTS',
            job__api__pb2.UploadWeightRequest.SerializeToString,
            job__api__pb2.ServerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
